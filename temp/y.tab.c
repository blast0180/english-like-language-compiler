...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VERB = 3,                       /* VERB  */
  YYSYMBOL_NOUN = 4,                       /* NOUN  */
  YYSYMBOL_ADWORD = 5,                     /* ADWORD  */
  YYSYMBOL_PUNCTUATION = 6,                /* PUNCTUATION  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VERB", "NOUN",
  "ADWORD", "PUNCTUATION", "PREPOSITION", "NUMBER", "$accept", "A", "B",
  "C", "D", YY_NULLPTR
};
